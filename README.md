...
`auto*` implementation remains in the Evolve compatibility adapter `src/adapters/evolve/evolve-runtime.js`. Shared achievement and challenge run-eligibility
