...
export interface BattleAdapterDependencies {
  // CHARACTERIZATION-ONLY: the production DeadSpace path is the captured adapter in battle.ts.
  // This manager bridge remains only for the frozen Vue2 characterization runtime and tests.
