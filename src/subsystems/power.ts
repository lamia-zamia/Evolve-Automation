...
type Dependencies = SubsystemDependencies<
  ...
  | "getBuildingIds"
>;
export function createAutoPower({ getGame, getSettings, getState, getResources, getBuildings, getJobs, getWindow, getPoly, getBuildingManager, getFleetManager, getMechManager, getWarManager, consumptionBalanceMin, Support, getPowerOscLock, getPowerWarnCap, getCitadelConsumption, isHellSupressUseful, getGalaxyRegions, traitVal, getHaveTech, adjustSpire, getBestSupplyRatio, getHealingRate, isHungryRace, isPillarFinished, getJQuery, getBuildingIds }: Dependencies) {
