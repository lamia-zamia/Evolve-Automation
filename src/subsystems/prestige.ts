...
>;
export function createAutoPrestige({ getState, getSettings, getGame, getResources, getBuildings, getWarManager, getHaveTech, getVueById, logPrestige, getIsBioseederPrestigeAvailable, isCataclysmPrestigeAvailable, loadQueuedSettings, getTechIds, isWhiteholePrestigeAvailable, isApocalypsePrestigeAvailable, isWitchAscensionPrestigeAvailable, isAscensionPrestigeAvailable, KeyManager, isDemonicPrestigeAvailable }: Dependencies) {
