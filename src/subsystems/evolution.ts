...
>;
export function createAutoEvolution({ getGame, getState, getSettings, getSettingsRaw, getRaces, loadQueuedSettings, GameLog, getChallenges, getEvolutions, getPoly, getResources, getImitations, getAutoUniverseSelection, getAutoPlanetSelection }: Dependencies) {
  return function autoEvolution() {
    ...
    const userImitateRace = (Object.values(imitations) as any[]).find((race) => {
