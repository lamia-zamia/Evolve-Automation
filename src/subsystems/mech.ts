...
type Dependencies = SubsystemDependencies<
  ...
  | "getJQuery"
>;
export function createAutoMech({ getMechManager, getGame, getSettings, getResources, getBuildings, getHaveTech, getHaveTask, average, GameLog, getJQuery }: Dependencies) {
