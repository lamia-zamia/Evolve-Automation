...
type Dependencies = SubsystemDependencies<
  ...
  | "getMouseEvent"
>;
export function createAutoPlanetSelection({ getGame, getSettings, getGeneratePlanets, getStarLevel, getIsAchievementUnlocked, getPlanetBiomeGenus, getRaces, getPlanetBiomes, getPlanetTraits, getDocument, getMouseEvent }: Dependencies) {
