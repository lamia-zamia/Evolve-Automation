...
assert.deepEqual(
  ...
  { progress: 40, target: "TitanDecoder", targetColonistCount: 0 },
);
assert.deepEqual(
  planTruepathAiApocalypse({ ...base, colonistCount: 43, colonistOnCount: 0 }),
  { progress: 40, target: null, targetColonistCount: 43 },
);
...
assert.equal(isTruepathAiResourceResearch("tech-protocol66"), false);
